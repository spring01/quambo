...
coulombVecModifier = reshape(obj.coulombMatModifier, [], 1);
exchangeVecModifier = reshape(obj.exchangeMatModifier, [], 1);
...
for iter = 1:obj.maxSCFIter
    ...
    fockVec = oeiVec + ... H
        2 .* (teiForCoulomb * densVec) .* coulombVecModifier ... % +2J
        - (teiForExchange * densVec) .* exchangeVecModifier; ... % -K
